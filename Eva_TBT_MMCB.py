...
def main():
    ...
    # protpaths.loc['S1','path_main'] = "F:/Mess_FU_Kort/"
    # protpaths.loc['S1','name_prot'] = "FU_Kort_S1-DBV_Protocol_220321.xlsx"

    # protpaths.loc[:,'path_con']     = "Messdaten/kon/"
    # protpaths.loc[:,'path_dic']     = "Messdaten/opt/"
    # protpaths.loc[:,'path_eva1']    = "Auswertung/"
    # protpaths.loc[:,'path_eva2']    = "Test_py/"    
        
    protpaths.loc['S1','name_prot'] = "FU_Kort_S1-DBV_Protocol_220321.xlsx"
    protpaths.loc['S1','path_con']  = "Messdaten/Serie_1/kon/"
    protpaths.loc['S1','path_dic']  = "Messdaten/Serie_1/opt/"
    protpaths.loc['S1','path_eva2'] = "Serie_1/"
    
    protpaths.loc['S2','name_prot'] = "FU_Kort_S2-DBV_Protocol_220713.xlsx"
    protpaths.loc['S2','path_con']  = "Messdaten/Serie_2/kon/"
    protpaths.loc['S2','path_dic']  = "Messdaten/Serie_2/opt/"
    ...
    if option == 'single':
        ...
        ser='S2'
        out_path = combpaths.loc[ser,'out']+ser+"_CBMM_TBT-Summary"
        ...
        out_path="F:/Mess_FU_Kort/Auswertung/Complete/CBMM_TBT-Summary"
        ...
        out_path="F:/Mess_FU_Kort/Auswertung/Complete/CBMM_TBT-Summary_all"
        packpaths = combpaths[['prot','out']]
        packpaths.columns=packpaths.columns.str.replace('out','hdf')
